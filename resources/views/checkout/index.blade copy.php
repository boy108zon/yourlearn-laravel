            ...
            <form method="POST" action="{{ route('checkout.process') }}" class="needs-validation" novalidate>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control @error('cc_name') is-invalid @enderror" id="cc-name" name="cc_name" required>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control @error('cc_number') is-invalid @enderror" id="cc-number" name="cc_number" required>
                        @error('cc_number')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="row">
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="text" class="form-control @error('cc_expiration') is-invalid @enderror" id="cc-expiration" name="cc_expiration" required>
                        @error('cc_expiration')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="text" class="form-control @error('cc_cvv') is-invalid @enderror" id="cc-cvv" name="cc_cvv" required>
                        @error('cc_cvv')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
