    ...
    <div class="container-fluid">
        <div class="card bg-white">
            <div class="card-header">
                <h5 class="card-title mb-0">Edit Role For: <b>{{$role->name}}</b></h5>
            </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" id="name" name="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name', $role->name) }}" required autocomplete="off">
                                @error('name')
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" id="badge_color" name="badge_color" class="form-control @error('badge_color') is-invalid @enderror" value="{{ old('badge_color', $role->badge_color) }}" autocomplete="off">
                                @error('badge_color')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
